    ...
    try {
      ...
      if (!response.ok) {
        const message = payload.errors
          ...
          : payload.message || 'Não foi possível gravar o procedimento.'
        pushToast('error', 'Erro ao gravar', message)
        return
      }
      ...
      pushToast(
        'success',
        'Sucesso',
        'Procedimento criado com sucesso. Redirecionando...'
      )
        ...
        <header className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-6 text-[30px] font-bold text-primary leading-tight">
              Cadastro de Procedimento Operacional
            </h1>
            <p className="text-on-surface-variant text-body-md mt-2">
              Preencha os dados abaixo para registrar uma nova diretriz de
        ...
        >
          ...
          <div className="col-span-12 flex justify-end gap-3 mt-6 pt-6 border-t border-border-subtle">
            ...
            >
              ...
              {loading ? 'Gravando...' : 'Gravar Registro'}
            </button>
          </div>
        </form>
      </main>
